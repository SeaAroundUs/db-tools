select 'INSERT INTO web.v_fact_data(
        ...
        WITH catch(main_area_id,year,taxon_key, data_layer_id, fishing_entity_id, gear_id, catch_type_id,reporting_status_id,sector_type_id,total_catch,unit_price) AS (
          SELECT ar.rfmo_id,
                 ad.year,
                 ad.taxon_key, 
                 ad.data_layer_id,
