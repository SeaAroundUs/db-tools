 select format('insert into allocation.allocation_result_high_seas
               select r.universal_data_id, a.fao_area_id, sum(r.allocated_catch)
                ...
                group by r.universal_data_id, a.fao_area_id', m.partition_id)
