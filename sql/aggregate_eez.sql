select 'INSERT INTO web.v_fact_data(
        ...
        WITH catch(sub_area_id,data_layer_id,year,taxon_key,fishing_entity_id,catch_type_id,catch_status,reporting_status,sector_type_id,total_catch,unit_price) AS (
