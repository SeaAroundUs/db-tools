select 'INSERT INTO web.v_fact_data(
        ...
        WITH catch(sub_area_id,data_layer_id,year,taxon_key,fishing_entity_id,catch_type_id,reporting_status_id,sector_type_id,total_catch,unit_price) AS (
      ...
      GROUP BY c.sub_area_id, c.data_layer_id, c.fishing_entity_id, tm.time_key, c.year, c.taxon_key, a.area_key, c.sector_type_id, c.catch_type_id, c.reporting_status_id'
