select 'INSERT INTO web.v_fact_data(
        ...
        WITH catch(sub_area_id,year,taxon_key,data_layer_id, fishing_entity_id, catch_type_id,catch_status,reporting_status,sector_type_id,total_catch,unit_price) AS (
          SELECT ar.area_id,
                 ad.year,
                 ad.taxon_key, 
                 ad.data_layer_id,
        ...
        SELECT 1,' ||
         ...
         GROUP BY c.data_layer_id, c.fishing_entity_id, tm.time_key, c.year, c.taxon_key, a.area_key, c.sector_type_id, c.catch_type_id, c.catch_status, c.reporting_status'
