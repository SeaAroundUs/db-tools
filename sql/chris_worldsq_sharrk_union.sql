...
Select s.shark_gid, st_multi(st_union(sw_intersection))::geometry(MultiPolygon,4326) 
...
Select s.world_gid, st_multi(st_union(sw_intersection))::geometry(MultiPolygon,4326) 
from shark_worldsq_int s
